...
const template = (list, _this) => html`
    <div style="display: flex; flex-direction: row;align-items: center">
        ...
        <input type="radio" checked @click=${e => _this.setAttribute("data-media-type", e.target.value)} name="type" id="movie" value="movie">
        <label for="movie">filmes</label>
        <input type="radio" @click=${e => _this.setAttribute("data-media-type", e.target.value)} name="type" id="tv" value="tv">
